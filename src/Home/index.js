...
const Home = () => {
  const {cartList, addCartItem, removeCartItem} = useContext(CartContext) // Access cartList and cart methods from CartContext
      ...
      <ul className="m-0 d-flex flex-column dishes-list-container">
        {categoryDishes.map(eachDish => (
          <DishItem
            ...
            cartItems={cartList} // Pass cartList as prop to DishItem
            addItemToCart={addCartItem} // Pass addCartItem function from CartContext
            removeItemFromCart={removeCartItem} // Pass removeCartItem function from CartContext
          />
        ))}
      </ul>
    )
